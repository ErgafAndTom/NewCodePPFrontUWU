...
import ChangeClienticons from "../../../artemm/Elements/img/Group 1476.png";
import barcode from "../../../artemm/public/mask-group-10.svg";
import profile from "../../../artemm/public/mask-group-11@2x.png";
import telegram from "../../../artemm/Elements/img/Telegram-icon-on-transparent-background-PNG.png";
import FilesButton from "../../../artemm/Elements/img/files-icon.png";
import addclienticons from "../../../artemm/Elements/img/Path 13360.png";
                    ...
                    <div className="ClientsMenu">
                        <div className="d-flex">
                            ...
                            <div className="middle-section">
                                <div className="username">{thisOrder.User.username}</div>
                                <div className="contact-number">
                                    {thisOrder.User.phoneNumber}
                                    <div className="messenger-icons">
                                        <img src={thisOrder.User.signal} alt="Signal"
                                             onClick={() => openMessenger('signal')}/>
                                        <img src={thisOrder.User.viber} alt="Viber"
                                             onClick={() => openMessenger('viber')}/>
                                        <img src={thisOrder.User.watsap} alt="WhatsApp"
