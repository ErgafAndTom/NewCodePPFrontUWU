        ...
        <svg viewBox="0 0 662 169" style={{width: "32vw", height: "20vh"}}>
            <g transform="translate(392.5 133.656)">
                <g transform="translate(-34)" onClick={handlePaymentClick} style={{ cursor: 'pointer' }}>
                    ...
                    <text transform="translate(89 13)" fontSize="14" fontFamily="GothamOffice-Regular, Gotham Office">
                        <tspan x="-84.665" y="0">Оплатити замовлення</tspan>
                    </text>
                </g>
            </g>
            <text transform="translate(11 11.828)" fill="#212529" fontSize="16" fontFamily="GothamOffice-Regular, Gotham Office">
                <tspan x="0" y="15">Сума всього замовлення:</tspan>
            </text>
            <text transform="translate(11 41.828)" fill="#212529" fontSize="16" fontFamily="GothamOffice-Regular, Gotham Office">
                <tspan x="0" y="15">Знижка</tspan>
            </text>
            <text transform="translate(11 71.828)" fill="#212529" fontSize="16" fontFamily="GothamOffice-Regular, Gotham Office">
                <tspan x="0" y="15">Загальна сума</tspan>
            </text>
            <text transform="translate(11 130.172)" fill="#212529" fontSize="16" fontFamily="GothamOffice-Regular, Gotham Office">
                <tspan x="0" y="15">К оплаті</tspan>
            </text>
            <text transform="translate(317.5 11)" fill="#212529" fontSize="16" fontFamily="GothamOffice-Regular, Gotham Office">
                <tspan x="0" y="15">грн</tspan>
            </text>
            <text transform="translate(317.5 41)" fill="#212529" fontSize="16" fontFamily="GothamOffice-Regular, Gotham Office">
                <tspan x="0" y="15">грн/відсоток</tspan>
            </text>
            <text transform="translate(317.5 131.578)" fill="#212529" fontSize="16" fontFamily="GothamOffice-Regular, Gotham Office">
                <tspan x="0" y="15">грн</tspan>
            </text>
            ...
            <g onClick={handleWorkClick} style={{cursor: 'pointer'}}>
                <rect width="146" height="47" rx="12" transform="translate(514 12)" fill="#fc0"
                      />
                <text transform="translate(588 39)" fontSize="11" fontFamily="GothamOffice-Bold, Gotham Office"
                      fontWeight="700">
                    <tspan x="-46.75" y="0">Взяти в роботу</tspan>
                </text>
            </g>
            <text transform="translate(11.5 100.598)" fill="#212529" fontSize="16"
                  fontFamily="GothamOffice-Regular, Gotham Office">
            ...
            <g transform="translate(358 99.676)" onClick={handleDepositClick} style={{ cursor: 'pointer' }}>
                ...
                <text transform="translate(85 17)" fontSize="14" fontFamily="GothamOffice-Regular, Gotham Office">
