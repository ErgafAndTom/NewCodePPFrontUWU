                                    ...
                                    {thing.productunits ? (
                                        <div className="d-flex flex-column" style={{width: '37.7vw'}}>
                                            ...
                                            <div className="d-flex">
                                                <div className="adminFontTable  bg-light">id: {thing.id}.</div>
                                                <div
                                                    className="adminFontTable  bg-light">Назва: {thing.name}.
                                                </div>
                                                <div
                                                    className="adminFontTable  bg-light">Кількість {thing.amount} шт.
                                                </div>
                                                <div
                                                    className="adminFontTable  bg-warning">Коштує(за
                                                    одиницю): {thing.priceForThis}грн.
                                                </div>
                                                <div
                                                    className="adminFontTable  bg-warning">Коштує
                                        ...
                                        <div className="d-flex flex-column border-light" style={{width: '37.7vw'}}>
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div
                                                    className="adminFontTable  bg-warning">Коштує ({thing.amount}шт): {thing.priceForThis}грн.
                                                </div>
                                            </div>
                                            <Form.Control
                                                type="number"
