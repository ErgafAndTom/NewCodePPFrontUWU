...
const ButtonE = ({nameOfX, buttonsArr, selectArr}) => {
    ...
    return (
        <div style={{ display: 'flex', alignItems: 'center', }}>
            ...
            <span style={{fontSize: '1.273vw', marginRight: '0.633vw', fontFamily: "Gotham", fontWeight: "bold"}}>{nameOfX}</span>
            <select value={radius} onChange={handleSelectChange} style={{backgroundColor: 'transparent', fontFamily: "Gotham", padding: '0.633vh 1.273vw', fontSize: '1.3vw', borderRadius: '0.5vw', border: '0.15vw solid grey' }}>
